...
final class MailTemplateController extends Controller
{
    ...
    public function preview(Request $request, MailTemplate $mailTemplate): JsonResponse
    {
        ...
        $html = view('emails.layout-preview', [
            ...
            'currentYear'      => date('Y'),
            'themePrimary'     => \App\Models\Setting::getValue('mail_theme_primary_color', '#4a7c43'),
            'themePrimaryDark' => \App\Models\Setting::getValue('mail_theme_primary_dark_color', '#2d5a27'),
            'themeBg'          => \App\Models\Setting::getValue('mail_theme_bg_color', '#f0f4e8'),
            'themeCardBg'      => \App\Models\Setting::getValue('mail_theme_card_bg_color', '#ffffff'),
            'themeText'        => \App\Models\Setting::getValue('mail_theme_text_color', '#4a4a4a'),
            'themeMuted'       => \App\Models\Setting::getValue('mail_theme_muted_color', '#888888'),
            'themeFooterText'  => \App\Models\Setting::getValue('mail_theme_footer_text', 'Çiftliğimizden sofranıza, doğallığın en taze hali.'),
