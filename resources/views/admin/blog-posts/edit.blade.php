...
@section('content')
<form method="POST" action="{{ route('admin.blog-posts.update', $post) }}" enctype="multipart/form-data" id="blogPostForm">
    @csrf
    @method('PUT')
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <div class="d-flex justify-content-between mt-1">
                    ...
                    <div class="form-text"><span id="title-counter">{{ Str::length(old('title', $post->title ?? '')) }}</span>/120</div>
                  </div>
                </div>
                ...
                <div class="col-12">
                  ...
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                  <div class="form-text">URL kısmını isteğe göre düzenleyebilirsiniz</div>
                </div>
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <div class="d-flex justify-content-between mt-1">
                    ...
                    <div class="form-text"><span id="excerpt-counter">{{ Str::length(old('excerpt', $post->excerpt ?? '')) }}</span>/300</div>
                  </div>
                </div>
            ...
            <div class="card-body-custom">
              <div class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <div class="mb-2">
                    <img src="{{ upload_url($post->image, 'md') }}" alt="{{ $post->title }}" class="img-fluid rounded" loading="lazy">
                  </div>
                </div>
                @endif
                ...
                <div class="col-12">
                  <label class="form-label" for="image">
                    {{ $post->image ? 'Yeni Kapak Görseli' : 'Kapak Görseli' }}
                  </label>
                  <input
                    type="file"
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <div class="ca-seo-preview">
                    <div class="ca-seo-url">{{ config('app.url') }}/blog/<span id="seoPreviewSlug">{{ $post->slug }}</span></div>
                    <div class="ca-seo-title" id="seoPreviewTitle">{{ $post->meta_title ?: $post->title }}</div>
                    <div class="ca-seo-desc" id="seoPreviewDesc">{{ $post->meta_description ?: Str::limit($post->excerpt ?? '', 160) }}</div>
                  </div>
                </div>
                ...
                <div class="col-12">
                  ...
                  <div class="d-flex justify-content-between mt-1">
                    ...
                    <div class="form-text"><span id="meta_title-counter">{{ Str::length(old('meta_title', $post->meta_title ?? '')) }}</span>/60</div>
                  </div>
                </div>
                ...
                <div class="col-12">
                  ...
                  <div class="d-flex justify-content-between mt-1">
                    ...
                    <div class="form-text"><span id="meta_description-counter">{{ Str::length(old('meta_description', $post->meta_description ?? '')) }}</span>/160</div>
                  </div>
                </div>
