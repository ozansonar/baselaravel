                    ...
                    <div class="card-header-custom">
                        <div class="form-section-header mb-0">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Soru metnini ve cevabını düzenleyin</small>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('answer') is-invalid @enderror"
                                          ...
                                          placeholder="Cevabı yazın..." required>{{ old('answer', $faq->answer) }}</textarea>
                                @error('answer')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('is_active') is-invalid @enderror"
                                    ...
                                    <option value="0" {{ old('is_active', $faq->is_active) == 0 ? 'selected' : '' }}>Pasif</option>
                                </select>
                                @error('is_active')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
