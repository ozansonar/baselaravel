...
@section('page_description', $product->name)
...
<form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data" id="productForm">
    ...
    <textarea name="description" id="descriptionField" class="d-none">{{ old('description', $product->description) }}</textarea>
        ...
        <div class="col-12 col-lg-9">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                   id="productName" name="name" value="{{ old('name', $product->name) }}" required
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                       id="productSlug" name="slug" value="{{ old('slug', $product->slug) }}" placeholder="otomatik-oluşturulur">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('unit') is-invalid @enderror"
                                   id="productUnit" name="unit" value="{{ old('unit', $product->unit) }}"
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('short_description') is-invalid @enderror"
                                      ...
                                      oninput="updateCharCounter(this, 300)">{{ old('short_description', $product->short_description) }}</textarea>
                            <div class="d-flex justify-content-between mt-1">
                        ...
                        <div class="col-12">
                            ...
                            <div class="ca-editor-wrapper">
                                ...
                                <div class="ca-editor-body" id="productEditor" contenteditable="true">{!! old('description', $product->description) !!}</div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control @error('price') is-invalid @enderror"
                                       id="productPrice" name="price" value="{{ old('price', $product->price) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control @error('discounted_price') is-invalid @enderror"
                                       id="productComparePrice" name="discounted_price"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('sku') is-invalid @enderror"
                                       id="productSku" name="sku" value="{{ old('sku', $product->sku) }}" placeholder="SKU-0001" required>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('stock') is-invalid @enderror"
                                           id="productStock" name="stock" value="{{ old('stock', $product->stock) }}" placeholder="0" min="0" required>
                                    @error('stock')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                ...
                <div class="card-body-custom">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            @if($product->image)
                            <div class="mb-2">
                                <img src="{{ upload_url($product->image, 'sm') }}" alt="{{ $product->name }}"
                                     class="img-fluid rounded prd-existing-preview" loading="lazy">
                            </div>
                            @endif
                        ...
                        <div class="col-12">
                            ...
                            @php
                                $existingImages = $product->images->map(function ($img) {
                                    return [
                                        'id'   => $img->id,
                                        'url'  => upload_url($img->image, 'thumb'),
                                        'name' => $img->alt_text ?? 'Görsel',
                                    ];
                                });
                            @endphp
                            <div class="dropzone ca-dropzone-area" id="galleryDropzone"
                                 data-upload-url="{{ route('admin.products.images.upload', $product) }}"
                                 data-reorder-url="{{ route('admin.products.images.reorder', $product) }}"
                                 data-existing-images="{{ $existingImages->toJson() }}">
            ...
            <div class="card-dark mb-4" id="section-features">
                ...
                <div class="card-body-custom">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="hasFeatures"
                               onchange="toggleFeaturesSection()"
                               {{ $product->features->count() > 0 ? 'checked' : '' }}>
                        <label class="form-check-label" for="hasFeatures">Bu ürün için özellikler ekle</label>
                    </div>

                    {{-- Özellikler Tablosu --}}
                    <div id="featuresSection" class="{{ $product->features->count() > 0 ? '' : 'd-none' }}">
            ...
            <div class="card-dark mb-4" id="section-nutrition">
                ...
                <div class="card-body-custom">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="hasNutrition"
                               onchange="toggleNutritionSection()"
                               {{ $product->nutritions->count() > 0 ? 'checked' : '' }}>
                        <label class="form-check-label" for="hasNutrition">Bu ürün için besin değerleri tablosu ekle</label>
                    </div>

                    {{-- Besin Değerleri Tablosu --}}
                    <div id="nutritionSection" class="{{ $product->nutritions->count() > 0 ? '' : 'd-none' }}">
                        <div class="table-responsive">
                            <table class="table cl-table mb-0" id="nutritionTable">
                                ...
                                <tbody id="nutritionTableBody">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-control-sm"
                                                   name="nutritions[{{ $index }}][per_value]"
                                                   value="{{ $nutrition->per_value }}"
                                                   placeholder="Ör: 350 kcal">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-control-sm"
                                                   name="nutritions[{{ $index }}][daily_value]"
                                                   value="{{ $nutrition->daily_value }}"
                                                   placeholder="Ör: %17">
                                        </td>
                                        <td>
            ...
            @php
                $shippingInfos = $product->shippingItems->where('type', 'shipping')->values();
                $returnInfos = $product->shippingItems->where('type', 'return')->values();
                $hasShippingData = $product->shippingItems->count() > 0;
            @endphp
            <div class="card-dark mb-4" id="section-shipping">
                ...
                <div class="card-body-custom">
                    ...
                    {{-- Kargo & İade Toggle --}}
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="hasShipping"
                               onchange="toggleShippingSection()"
                               {{ $hasShippingData ? 'checked' : '' }}>
                        <label class="form-check-label" for="hasShipping">Bu ürün için kargo & iade bilgileri ekle</label>
                    </div>

                    {{-- Kargo Bilgileri --}}
                    <div id="shippingSection" class="{{ $hasShippingData ? '' : 'd-none' }}">
                        ...
                        <div class="table-responsive">
                            <table class="table cl-table mb-0" id="shippingTable">
                                ...
                                <tbody id="shippingTableBody">
                                    @forelse($shippingInfos as $index => $item)
                                    <tr>
                                        <td>
                                            <input type="hidden" name="shipping_items[{{ $index }}][type]" value="shipping">
                                            <input type="text" class="form-control form-control-sm"
                                                   name="shipping_items[{{ $index }}][content]"
                                                   value="{{ $item->content }}"
                        ...
                        {{-- İade Bilgileri --}}
                        @php $returnStartIndex = $shippingInfos->count() > 0 ? $shippingInfos->count() : 1; @endphp
                        ...
                        <div class="table-responsive">
                            <table class="table cl-table mb-0" id="returnTable">
                                ...
                                <tbody id="returnTableBody">
                                    @forelse($returnInfos as $index => $item)
                                    <tr>
                                        <td>
                                            <input type="hidden" name="shipping_items[{{ $returnStartIndex + $index }}][type]" value="return">
                                            <input type="text" class="form-control form-control-sm"
                                                   name="shipping_items[{{ $returnStartIndex + $index }}][content]"
                                                   value="{{ $item->content }}"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="ca-seo-preview">
                                <span class="ca-seo-url">{{ config('app.url') }}/urun/<span id="seoSlugPreview">{{ $product->slug }}</span></span>
                                <h6 class="ca-seo-title" id="seoPreviewTitle">{{ $product->meta_title ?: $product->name . ' | Site Adı' }}</h6>
                                <p class="ca-seo-desc" id="seoPreviewDesc">{{ $product->meta_description ?: 'Ürünün meta açıklaması burada görünecektir...' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('meta_title') is-invalid @enderror"
                                   id="seoTitle" name="meta_title" value="{{ old('meta_title', $product->meta_title) }}"
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                      ...
                                      oninput="updateSeoPreview(); updateCharCounter(this, 160)">{{ old('meta_description', $product->meta_description) }}</textarea>
                            <div class="d-flex justify-content-between mt-1">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('sort_order') is-invalid @enderror"
                                   id="productOrder" name="sort_order" value="{{ old('sort_order', $product->sort_order) }}"
                                   placeholder="0" min="0">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="allowReviews"
                                       ...
                                       {{ old('allow_reviews', $product->allow_reviews) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="relatedProducts"
                                       ...
                                       {{ old('show_related', $product->show_related) ? 'checked' : '' }}>
