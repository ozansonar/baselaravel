...
@section('title', 'Yeni İçerik Kategorisi')
@section('page_title', 'Yeni Kategori')
@section('page_description', 'Blog içerikleri için yeni kategori oluşturun')
...
@section('content')
    ...
    <div class="page-header d-flex align-items-start align-items-sm-center justify-content-between flex-column flex-sm-row gap-3 mb-4" data-aos="fade-down">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h1 class="page-title mb-0">Yeni İçerik Kategorisi</h1>
                <p class="page-subtitle mb-0">Blog içerikleri için yeni kategori oluşturun</p>
            </div>
        </div>
