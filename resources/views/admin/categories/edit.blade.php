                    ...
                    <div class="card-body-custom">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">Boş bırakılırsa ana kategori olarak ayarlanır</div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          placeholder="Kategori açıklamasını yazın...">{{ old('description', $category->description) }}</textarea>
                                @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-header-custom">
                        <div class="form-section-header mb-0">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Kategori görseli yükleyin veya değiştirin</small>
                            </div>
                        </div>
                    </div>
                    <div class="card-body-custom">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-2">
                                    <img src="{{ upload_url($category->image, 'sm') }}" alt="{{ $category->name }}"
                                         class="rounded" height="80" loading="lazy">
                                </div>
                            </div>
                            @endif
                            <div class="col-12">
                                <label class="form-label" for="image">
                                    {{ $category->image ? 'Yeni Görsel' : 'Kategori Görseli' }}
                                </label>
                                <input type="file"
                                ...
                                <div class="form-text">
                                    ...
                                    @if($category->image)
                                        — Yeni görsel yüklerseniz mevcut görsel değiştirilir
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                          ...
                                          placeholder="Arama sonuçlarında görünecek açıklama metni...">{{ old('meta_description', $category->meta_description) }}</textarea>
