...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.popups.store') }}" enctype="multipart/form-data" data-validate novalidate>
        @csrf
                ...
                <x-language-tabs :languages="$formLanguages" id="popupLangTabs">
