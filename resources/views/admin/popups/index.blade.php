        ...
        <div class="card-body-custom">
            <form method="GET" action="{{ route('admin.popups.index') }}" class="cl-toolbar" id="filterForm">
                ...
                <div class="cl-search">
                    ...
                    <input type="text" name="search" id="popupSearch" placeholder="Popup başlığı ile ara..." value="{{ request('search') }}" data-fv-ignore>
                </div>
                                ...
                                <td data-label="İşlem">
                                    <div class="usr-actions">
                                        ...
                                        @else
                                            ...
                                            <button class="usr-action-btn danger" title="Sil" data-action="sil" data-id="{{ $popup->id }}" data-label="'{{ addslashes($popup->title) }}'"><i class="bi bi-trash"></i></button>
                                        @endif
                                    </div>
                                </td>
                            </tr>
