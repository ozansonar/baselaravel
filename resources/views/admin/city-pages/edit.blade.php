...
@section('title', 'Şehir Sayfası Düzenle')

@section('content')
<form method="POST" action="{{ route('admin.city-pages.update', $page) }}" id="cityPageForm">
    @csrf
    @method('PUT')
    ...
    <div class="page-header d-flex align-items-start align-items-sm-center justify-content-between flex-column flex-sm-row gap-3 mb-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h1 class="page-title mb-0">Şehir Sayfası Düzenle</h1>
                <p class="page-subtitle mb-0">{{ $page->city_name }}</p>
            </div>
        </div>
        <div class="d-flex gap-2 flex-wrap">
            @if($page->is_active)
                <a href="{{ url('/' . $page->city_slug . '-koy-urunleri') }}" target="_blank" class="btn-glass">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control @error('city_name') is-invalid @enderror"
                                   id="city_name" name="city_name" value="{{ old('city_name', $page->city_name) }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control @error('region') is-invalid @enderror"
                                   id="region" name="region" value="{{ old('region', $page->region) }}"
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('city_slug') is-invalid @enderror"
                                       id="city_slug" name="city_slug" value="{{ old('city_slug', $page->city_slug) }}">
                                <span class="input-group-text">-koy-urunleri</span>
                            </div>
                            @error('city_slug')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
                            <div class="form-text">Sadece küçük harf, sayı ve tire.</div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select class="form-select @error('tier') is-invalid @enderror" id="tier" name="tier">
                                @foreach([1 => 'Tier 1 — Büyük şehir (öncelikli)', 2 => 'Tier 2 — Orta ölçek', 3 => 'Tier 3 — Küçük şehir', 4 => 'Tier 4 — Çorum çevresi'] as $value => $label)
                                    <option value="{{ $value }}" {{ (int) old('tier', $page->tier) === $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('hero_heading') is-invalid @enderror"
                                   id="hero_heading" name="hero_heading" value="{{ old('hero_heading', $page->hero_heading) }}"
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('hero_description') is-invalid @enderror"
                                      id="hero_description" name="hero_description" rows="3" maxlength="500">{{ old('hero_description', $page->hero_description) }}</textarea>
                ...
                <div class="card-body-custom">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <textarea class="@error('content') is-invalid @enderror" id="content" name="content" rows="12">{{ old('content', $page->content) }}</textarea>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control" id="delivery_time" name="delivery_time"
                                   value="{{ old('delivery_time', $page->delivery_time) }}" maxlength="60"
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="shipping_note" name="shipping_note"
                                   value="{{ old('shipping_note', $page->shipping_note) }}" maxlength="255">
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="ca-seo-preview">
                                <div class="ca-seo-url">{{ config('app.url') }}/<span id="seoPreviewSlug">{{ $page->city_slug }}</span>-koy-urunleri</div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('meta_title') is-invalid @enderror"
                                   ...
                                   maxlength="70" oninput="updateCharCounter(this, 70); updateSeoPreview()">
                            @error('meta_title')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            <div class="d-flex justify-content-between mt-1">
                                <div class="form-text">Önerilen: 50-60 karakter</div>
                                <div class="form-text"><span id="meta_title-counter">{{ Str::length(old('meta_title', $page->meta_title ?? '')) }}</span>/70</div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                      ...
                                      oninput="updateCharCounter(this, 200); updateSeoPreview()">{{ old('meta_description', $page->meta_description) }}</textarea>
                            @error('meta_description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            <div class="d-flex justify-content-between mt-1">
                                <div class="form-text">Önerilen: 150-160 karakter</div>
                                <div class="form-text"><span id="meta_description-counter">{{ Str::length(old('meta_description', $page->meta_description ?? '')) }}</span>/200</div>
                            </div>
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="number" class="form-control" id="sort_order" name="sort_order"
                                   value="{{ old('sort_order', $page->sort_order) }}" min="0" max="9999">
                        </div>
