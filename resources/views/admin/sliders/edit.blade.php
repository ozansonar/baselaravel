                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('is_active') is-invalid @enderror"
                                    ...
                                    <option value="1" {{ old('is_active', $slider->is_active) == 1 ? 'selected' : '' }}>Aktif</option>
                                    <option value="0" {{ old('is_active', $slider->is_active) == 0 ? 'selected' : '' }}>Pasif</option>
                                </select>
                                @error('is_active')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="card-header-custom">
                        <div class="form-section-header mb-0">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Slider görseli yükleyin veya değiştirin</small>
                            </div>
                        </div>
                    </div>
                    <div class="card-body-custom">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-2">
                                    <img src="{{ upload_url($slider->image, 'sm') }}" alt="{{ $slider->title }}"
                            ...
                            <div class="col-12">
                                <label class="form-label" for="image">
                                    {{ $slider->image ? 'Yeni Görsel' : 'Slider Görseli' }} {{ !$slider->image ? '' : '' }}
                                </label>
                                <input type="file"
                                ...
                                @enderror
                                <div class="form-text">
                                    PNG, JPG, WebP | Önerilen boyut: 1920x600 piksel
                                    @if($slider->image)
