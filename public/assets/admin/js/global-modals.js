...
;(function () {
  ...
  function showConfirm(options) {
    ...
    // Texts
    document.getElementById('gcm-title').textContent = opts.title;
    document.getElementById('gcm-message').textContent = opts.message;
    document.getElementById('gcm-cancel-text').textContent = opts.cancelText;
    document.getElementById('gcm-confirm-text').textContent = opts.confirmText;
    ...
    if (opts.detailTitle) {
      ...
      document.getElementById('gcm-detail-title').textContent = opts.detailTitle;
      document.getElementById('gcm-detail-meta').textContent = opts.detailMeta || '';
    ...
    if (opts.warning) {
      ...
      document.getElementById('gcm-warning-text').textContent = opts.warning;
    } else {
  ...
  function showStatus(options) {
    ...
    // Texts
    document.getElementById('gsm-title').textContent = opts.title;
    document.getElementById('gsm-message').textContent = opts.message;
    document.getElementById('gsm-close-text').textContent = opts.buttonText;
