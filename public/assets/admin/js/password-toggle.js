 ...
 * gruba (stg-input-group / input-group) oturuyorsa düğme o grubun içine konur —
 * grup zaten tek satır olduğu için hizalama şaşmaz. Grupsuz alanlarda girdi
 * ince bir sarmalayıcıya alınır.
 *
...
(function () {
    ...
    var ICON_SHOW = 'bi bi-eye';
    var ICON_HIDE = 'bi bi-eye-slash';
    var LABEL_SHOW = 'Şifreyi göster';
    var LABEL_HIDE = 'Şifreyi gizle';

    /**
     * Düğmenin oturacağı kap: varsa alanın grubu, yoksa yeni bir sarmalayıcı.
     */
    function resolveHost(input) {
        var group = input.closest('.stg-input-group, .input-group');
